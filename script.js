...
function addClothing() {
    ...
    if (clothingImpact) {
        ...
        document.getElementById('water-impact').textContent = `${totalWaterImpact.toFixed(0)}`;
        document.getElementById('co2-impact').textContent = `${totalCo2Impact.toFixed(0)}`;
    } else {
        alert("Tipo de roupa ou tecido não está correto! \n(Tipo de tecido pode não existir!)");
    }
}
